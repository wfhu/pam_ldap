...
pkgdatadir = $(datadir)/pam_ldap
pkglibdir = $(libdir)/pam_ldap
pkgincludedir = $(includedir)/pam_ldap
top_builddir = .
...
DIST_COMMON = README $(am__configure_deps) $(srcdir)/Makefile.am \
	...
	INSTALL NEWS acconfig.h config.guess config.sub depcomp \
...
DIST_SOURCES = $(pam_ldap_so_SOURCES)
man5dir = $(mandir)/man5
...
infodir = ${prefix}/info
install_sh = /root/pam_ldap-186/install-sh
...
include ./$(DEPDIR)/pam_ldap.Po
include ./$(DEPDIR)/vers.Po
